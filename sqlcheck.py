...
if selected == "Home":
    ...
    st.markdown("## :red[Technologies used] : Python,MongoDB, Youtube Data API, MySql, Streamlit")
...
def create_table():
    ...
    channel_details = ("create table channel (channel_id varchar(255),channel_name varchar(255),subscription_count int, channel_views int,channel_description text);")
    mycursor.execute(channel_details)
                                                       
    video_details = ("create table video (video_Id varchar(255), playlist_id varchar(255), video_Name varchar(255), video_description text, published_date date, view_count int, like_count int, favorite_count int, comment_count int, duration int, thumbnail varchar(255), caption_status varchar(255));")
    mycursor.execute(video_details)
    
    comments_details = ("create table comments (comment_Id varchar(255), video_Id varchar(255), comment_text text, comment_author varchar(255), comment_published_date date);")
