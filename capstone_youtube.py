...
client = pymongo.MongoClient("your connection id")
db = client.youtube
...
if selected == "Get Data & Transform":
    ...
    with tab1:
        ...
        ch_id = st.text_input("Hint : Go to the YouTube website (https://www.youtube.com) > channel's home page > Right click > View page source > Find channel_id").split(',')
